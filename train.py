...
parser.add_argument('--shp_file_path', type=str, default='E:\\UP\\data\\MADRID\\MADRID.shp', help='Path to load shp file.')
parser.add_argument('--geo_info_path', type=str, default='E:\\UP\\data\\MADRID\\MADRID_GEO_INFO_MASKED_ex.csv', help='Path to load masked_geo_info.')
parser.add_argument('--save_path', type=str, default='E:\\UP\\ckpt', help='Path to save models and logs.')
parser.add_argument('--city_name', type=str, default='MADRID', help='City name.')
